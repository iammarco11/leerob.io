  ...
  return (
    <footer className="flex flex-col items-center mb-8">
      ...
      <div className="flex space-x-4 mb-4">
        <ExternalLink href="https://twitter.com/akshaay_11">
        ...
        <ExternalLink href="https://github.com/iammarco11">
        ...
        <ExternalLink href="https://www.linkedin.com/in/iammarco11">
        ...
        <ExternalLink href="https://www.youtube.com/channel/UCeQOviN4Y6Lfgu8mrKnO9gw">
        ...
        <ExternalLink href="mailto:akshay@amfoss.in">
